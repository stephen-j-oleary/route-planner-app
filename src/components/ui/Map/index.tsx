...
export default function GoogleMap({
  ...
  const { map, setMap, markupCoordinates } = useMap();
  ...
  React.useEffect(
    ...
    [theme, setMap, mapTypeControl, fullscreenControl, streetViewControl, gestureHandling, backgroundColor]
  );
