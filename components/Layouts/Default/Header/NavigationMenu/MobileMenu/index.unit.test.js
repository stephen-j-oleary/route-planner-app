...
describe("MobileMenu", () => {
  ...
  it("calls reactPortal for menu when menuPortal prop is passed", () => {
    const menuPortal = "menuPortal";
    render(
      <MobileMenu
        {...MINIMAL_PROPS}
  ...
  it("calls reactPortal for backdrop when backdropPortal prop is passed", () => {
    const backdropPortal = "backdropPortal";
    render(
      <MobileMenu
        {...MINIMAL_PROPS}
